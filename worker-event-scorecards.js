...
function ranked(entries,value){return [...entries].filter(x=>Number.isFinite(Number(value(x)))).sort((a,b)=>Number(value(b))-Number(value(a))||String(a.label||'').localeCompare(String(b.label||'')))}
